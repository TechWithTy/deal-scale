...
export const dataEnrichmentProblemsSolutions: ServiceProblemSolution[] = [
	{
		...
		solution:
			"Use our Phone Validation tool to instantly scrub your lists, identify and remove disconnected numbers, and improve your connection rates.",
	},
	{
		problem:
			"I have a property address, but no idea who the owner is or how to contact them.",
		solution:
			"Our Reverse Address Lookup enriches a physical address with current owner names, phone numbers, and email addresses.",
	},
	{
		problem:
			"An inbound call comes from an unknown number, and I have to answer blind without any context.",
		solution:
			"Caller Identification automatically displays the name of the individual or business calling, allowing you to answer with confidence.",
	},
	{
		problem:
			"My data on a lead is incomplete. I have a name but no current phone or address.",
		solution:
			"Find Person takes a name and last known location to find up-to-date contact information, including verified phones, emails, and addresses.",
	},
];
...
export const aiDirectMailNurturingProblemsSolutions: ServiceProblemSolution[] =
	[
		...
		},
		{
			...
			solution:
				"Automate your entire direct mail nurturing process within Deal Scale – from design personalization and list segmentation to printing and mailing via our integrated fulfillment network.",
		},
		{
			problem:
