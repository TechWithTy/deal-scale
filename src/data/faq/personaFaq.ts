export type PersonaKey = "agent" | "investor" | "wholesaler" | "agency" | "enterprise";
...
export const PERSONA_FAQ_ITEMS: PersonaFaqItem[] = [
	{
		...
		answers: {
			...
			investor:
				"DealScale helps you find and qualify motivated sellers faster. It combines unlimited skip tracing with AI voice and SMS outreach that runs automatically—so you can focus on offers and closings instead of manual lead chasing.",
			wholesaler:
	...
	{
		id: "compliance",
		question: "Is DealScale compliant with TCPA, GDPR, and the Colorado AI Act?",
		answers: {
			agent:
...
> = {
	...
	agency: {
		id: "agency-advanced",
		question: "What’s the best way to upsell clients once campaigns are working?",
		answer:
