...
export const featureTimeline: FeatureTimelineMilestone[] = [
	...
	},
	{
		...
		highlights: [
			...
			"Early CRM Sync (GoHighLevel, Podio, Salesforce, Follow Up Boss, Lofty)",
	...
	},
	{
		quarter: "Q1 2026",
		status: "In Build",
		initiative: "Expanded CRM Integrations",
		focus: "Universal CRM Connectivity & Bi-Directional Sync",
		summary:
			"Expanding beyond pilot CRMs to include GoHighLevel, Follow Up Boss, HubSpot, Zoho, and other major platforms. Full bi-directional sync, webhook support, and real-time data flow.",
		highlights: [
			"GoHighLevel integration with funnel automation sync",
			"Follow Up Boss bi-directional contact & deal sync",
			"HubSpot CRM integration with pipeline mapping",
			"Zoho CRM sync with custom field mapping",
			"Lofty integration for investor workflows",
			"Real-time webhook support for instant updates",
			"Custom field mapping for all CRM platforms",
			"Bulk import/export with conflict resolution",
			"Activity Stream integration for all CRM events",
		],
	},
	{
		quarter: "Q1 2026",
	...
	},
	{
		quarter: "Q2 2026",
		status: "Planned",
		initiative: "Automation Platform Integrations",
		focus: "Workflow Orchestration & Partner Ecosystem",
		summary:
			"Deep integrations with leading automation platforms to enable enterprise-grade workflow orchestration. Connect Deal Scale to your existing automation infrastructure.",
		highlights: [
			"N8N integration for visual workflow automation",
			"Make (formerly Integromat) connector for complex automations",
			"Kestra integration for data pipeline orchestration",
			"Lead Orchestra integration for lead routing & distribution",
			"Anywhere integration for multi-platform lead sync",
			"Apify integration for web scraping & data extraction",
			"Custom webhook endpoints for all platforms",
			"Event-driven triggers across all integrations",
			"Unified Activity Stream for all partner events",
		],
	},
	{
		quarter: "Q3 2026",
		...
		summary:
			"Public onboarding, full voice automation, multi-tenant dashboard, and complete partner ecosystem. Growth + sales machines built from your social outreach engine.",
		highlights: [
			"Public onboarding (self-serve)",
			"Full voice automation",
			"Multi-tenant dashboard",
			"Real-time analytics refinement",
			"Complete CRM & automation platform ecosystem",
