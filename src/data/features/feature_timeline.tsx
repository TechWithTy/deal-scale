...
export const featureTimeline: FeatureTimelineMilestone[] = [
	...
	},
	{
		...
		highlights: [
			...
			"Early CRM Sync ([Podio](https://www.podio.com), [Salesforce](https://www.salesforce.com), [FUB](https://www.followupboss.com), [Lofty](https://www.lofty.com))",
	...
	},
	{
		...
		highlights: [
			...
			"Print automation integrations ([Lob](https://www.lob.com), [PostGrid](https://www.postgrid.com), [Click2Mail](https://www.click2mail.com))",
