...
describe("server entry pages", () => {
        ...
        it("hydrates the home page from data modules", async () => {
                ...
                const caseStudiesGrid = elements.find(
                        (element) => element.type === CaseStudyGridMock,
                );
                const testimonials = elements.find(
                        (element) => element.type === TestimonialsMock,
                );
                const faq = elements.find((element) => element.type === FaqMock);
                const pricing = elements.find((element) => element.type === PricingMock);
                ...
                expect(testimonials?.props).toMatchObject({
                        testimonials:
                                mockDataModules["service/slug_data/testimonials"].generalDealScaleTestimonials,
                });
