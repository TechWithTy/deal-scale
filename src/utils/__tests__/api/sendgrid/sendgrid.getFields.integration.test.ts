...
let getSendGridFieldsImpl: typeof import("@/lib/externalRequests/sendgrid/getFields").getSendGridFields;
if (isExternalIntegrationEnabled) {
        ({ getSendGridFields: getSendGridFieldsImpl } = require("@/lib/externalRequests/sendgrid/getFields"));
}
